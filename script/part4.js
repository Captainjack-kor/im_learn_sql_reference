...
*/
const PART4_2 = `SELECT u.name FROM user AS u;`;
...
*/
const PART4_3 = `INSERT INTO user (name, email) VALUES ('songhwachoe', 'songhwa.choe@hospital.playlist.io');`;
...
*/
const PART4_4 = `SELECT * FROM user AS u WHERE u.name = 'duhyunkim';`;
...
*/
const PART4_5 = `SELECT * FROM user AS u WHERE u.name <> 'duhyunkim';`;

/*
----------------------------------------------------------------------------------------------
    TODO: Q 4-6. content 테이블에 존재하는 모든 데이터에서 title 컬럼만을 찾기 위한 SQL을 작성해주세요.
*/
const PART4_6 = `SELECT c.title FROM content AS c;`;
...
*/
const PART4_7 = `SELECT c.title, u.name FROM content AS c LEFT JOIN user AS u ON u.id = c.userId;`;
...
*/
const PART4_8 = `SELECT c.title, u.name FROM content AS c JOIN user AS u ON u.id = c.userId;`;
...
*/
const PART4_9 = `UPDATE content AS c SET c.body = 'database is very easy' WHERE c.title = 'database sprint';`;
...
*/
const PART4_10 = `INSERT INTO content (title, body, userId) VALUES ('latte is', 'HORSE!!', 1);`;
